...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'business-locations', loadChildren: () => import('../business-location-page/business-location-page.module').then(m => m.BusinessLocationPageModule) },
      ...
      { path: 'setup-details', loadChildren: () => import('../business-setup-details-page/business-setup-details-page.module').then(m => m.BusinessSetupDetailsPageModule) },
      { path: 'client-sources', loadChildren: () => import('../business-setup-client-sources-page/business-setup-client-sources-page.module').then(m => m.BusinessSetupClientSourcesPageModule) },
