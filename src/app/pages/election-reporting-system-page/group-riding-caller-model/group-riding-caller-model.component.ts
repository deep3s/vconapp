...
@Component({
  selector: 'app-group-riding-caller-model',
  templateUrl: './group-riding-caller-model.component.html',
  styleUrls: ['./group-riding-caller-model.component.scss']
})
export class GroupRidingCallerModelComponent implements OnInit, AfterViewInit {
    ...
    constructor(private formBuilder: FormBuilder,
                ...
                public dialogRef: MatDialogRef<GroupRidingCallerModelComponent>,
